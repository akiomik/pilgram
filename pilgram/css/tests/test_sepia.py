...
def test_sepia_1() -> None:
    ...
    assert list(sepiaed_im.get_flattened_data()) == list(
        sepiaed_im2.get_flattened_data()
    )
    assert sepiaed_im.size == im.size
    assert sepiaed_im.mode == im.mode
...
def test_sepia_0() -> None:
    ...
    assert list(sepiaed_im.get_flattened_data()) == list(im.get_flattened_data())
    assert sepiaed_im.size == im.size
    assert sepiaed_im.mode == im.mode
...
def test_sepia_hsv() -> None:
    ...
    assert list(sepiaed_im.get_flattened_data()) == list(
        sepiaed_im2_rgb.get_flattened_data()
    )
